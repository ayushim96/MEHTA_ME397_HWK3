...
What is the least cost optimal mix of solar,wind and energy storage system (ESS) to deliver a constant amount of power demand?  
"""
...
status.write(filename='MEHTA_HWK3_OUTPUTS.json', format='json')
